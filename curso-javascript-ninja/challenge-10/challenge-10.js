(function (){
        ...
        */
        ...
        number1 = 5;
        number2 = 10;
        console.log(sum === false ? showErrorMessage(operationSignal) : showOperationMessage(operationSignal,number1,number2) + sum(number1,number2));
       ...
       number1 = 100;
       number2 = 50;
       console.log(subtraction === false ? showErrorMessage(operationSignal) : showOperationMessage(operationSignal,number1,number2) + subtraction(number1,number2));

        operationSignal = "*";
        var multiplication = calculator(operationSignal);
        number1 = 5;
        number2 = 5;
        console.log(sum === false ? showErrorMessage(operationSignal) : showOperationMessage(operationSignal,number1,number2) + multiplication(number1,number2));
        ...
        number1 = 1000;
        number2 = 100;
        console.log(division === false ? showErrorMessage(operationSignal) : showOperationMessage(operationSignal,number1,number2) + division(number1,number2));
        ...
        number1 = 20;
        number2 = 2;
        console.log(sum === false ? showErrorMessage(operationSignal) : showOperationMessage(operationSignal,number1,number2) + mod(number1,number2));
        ...
        */
       operationSignal = "phablo";
       var error = calculator(operationSignal);
       console.log(error === false ? showErrorMessage(operationSignal) : showOperationMessage(operationSignal,number1,number2) + mod(number1,number2));
