(function(){
    ...
    */
    ...
    brasil.splice(0,0,'para','rondonia');
    ...
    */
    ...
    nordeste.forEach(function(index){
            brasil.push(index);
    })
    ...
    */
    ...
    console.log(letras ? "Sim, todos os estados tem mais de 7 letras!" : "Nem todos os estados tem mais de 7 letras!" );
    ...
    */
    ...
    var isCeara = brasil.some(function(estado){
        return estado === 'Ceará';
    })
    console.log( '\nCeará está incluído em `brasil`?' );
    console.log(isCeara ? "Ceará está incluído!" :"Ceará não foi incluído :(" );
