...
desafio.
*/
var teams = ["Flamengo","Vasco","Fluminense","botafogo","boa vista"]
...
function showTeamPosition(num){
    ...
    var time = teams[num-1];


    return  time !== undefined ? "O time que está em "+num+"º lugar é o "+time : "Não temos a informação do time que está nessa posição.";
}
...
function convertToHex(cor){
    ...
    var hexa = "O hexadecimal para a cor "+cor+" é ";
